...
export function CityPageView({ data: city, currentPath, parents = [] }: CityViewProps) {
  ...
  const trainingDays = [...new Set(groups.map((g) => g.days).filter(Boolean))].join(', ')
        ...
        <section className="container mx-auto px-4">
          <div className="relative overflow-hidden rounded-3xl border border-primary/40">
            ...
            <div
              ...
              style={{
                background:
                  'linear-gradient(100deg, oklch(0.13 0.01 280 / 0.94) 30%, oklch(0.13 0.01 280 / 0.55) 60%, oklch(0.58 0.24 290 / 0.25))',
              }}
            />
            <div className="relative max-w-2xl px-8 py-14 md:px-14 md:py-16">
              ...
              {city.hero_content && (
                <div
                  className="mt-4 max-w-xl text-base leading-relaxed text-white/80 md:text-lg [&_strong]:text-white"
              ...
              <div className="mt-7 flex flex-wrap gap-3">
                ...
                <Link
                  href="/grafik/"
                  className="inline-flex items-center gap-2 rounded-full border border-white/35 px-6 py-3 font-mono text-xs font-bold uppercase tracking-[0.12em] text-white transition-colors hover:border-cyan hover:text-cyan"
                >
                  Sprawdź grafik
                </Link>
              </div>
              <div className="mt-7 flex flex-wrap gap-x-6 gap-y-2 font-mono text-[11px] uppercase tracking-[0.12em] text-white/65">
        ...
        <section className="container mx-auto px-4 pt-4">
          <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
            ...
            <div className="rounded-3xl border border-border bg-card p-5">
              ...
              <p className="font-mono text-[11px] text-muted-foreground">dzieci · młodzież · dorośli</p>
            </div>
            <div className="rounded-3xl border border-border bg-card p-5">
              ...
              <div className="overflow-hidden rounded-3xl border border-border bg-card">
                ...
                <div className="p-6">
                  ...
                  <a
                    ...
                    className="mt-4 inline-flex items-center gap-2 rounded-full border border-amber/40 px-5 py-2.5 font-mono text-[11px] font-bold uppercase tracking-[0.12em] text-amber transition-colors hover:bg-amber/10"
                  >
